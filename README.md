...
- **Fully reproducible**: Pass `random_seed` to control both TAU's internal numpy RNG and igraph's Leiden RNG — same seed always produces identical results.
...
| `random_seed` | `None` | int or None | Seeds both numpy and igraph's Leiden RNG for full reproducibility |
